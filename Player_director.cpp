...
Player* Player_director::make_warrior()
{
	...
	builder->build_name("–ыцарь Ѕдыщ-а-лот");
...
Player* Player_director::make_mage()
{
	...
	builder->build_name("¬олшебник ћэр Ћинг");
...
{
	std::cout << "’отите установить здоровье персонажа? y/n" << std::endl;
	char ans;
	std::cin >> ans;
	if (ans == 'y')
	{
	...
	std::cout << "’отите установить ресурс персонажа? y/n" << std::endl;
	std::cin >> ans;
	if (ans == 'y')
	{
	...
	std::cout << "’отите установить им¤ персонажа? y/n" << std::endl;
	std::cin >> ans;
	if (ans == 'y')
	{
	...
	std::cout << "’отите установить карму персонажа? y/n" << std::endl;
	std::cin >> ans;
	if (ans == 'y')
	{
	...
	/*std::cout << "’отите установить класс персонажа? y/n" << std::endl;
	std::cin >> ans;
	if (ans == 'y')
	{
		builder->build_class(-1,-1);
